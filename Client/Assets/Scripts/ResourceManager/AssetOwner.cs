...
public class AssetOwner
{
    ...
    public void RemoveAssetHandle(AssetHandleBase ahb)
    {
    ...
    private AssetHandle<GameObject> InstantiateAsync(object key, AsyncOperationHandle<GameObject> aoh,
        Action<AssetHandle<GameObject>> completed)
    {
        m_assetHandleId++;
    ...
    /// <param name="completed"></param>
    /// <returns></returns>
    public AssetHandle<GameObject> InstantiateAsync(object key, Vector3 position, Quaternion rotation,
        Action<AssetHandle<GameObject>> completed)
    {
    ...
    /// <param name="completed"></param>
    /// <returns></returns>
    public AssetHandle<GameObject> InstantiateAsync(object key, Transform parent,
        Action<AssetHandle<GameObject>> completed)
    {
    ...
    /// <param name="completed"></param>
    /// <returns></returns>
    public AssetHandle<GameObject> InstantiateAsync(object key, Transform parent, Vector3 position, Quaternion rotation,
        Action<AssetHandle<GameObject>> completed)
    {
